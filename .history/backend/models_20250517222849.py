...
# Create Appointment Pydantic model with related fields
Appointment_Pydantic = pydantic_model_creator(
    Appointment,
    name="Appointment",
    computed=["doctor_name", "patient_name"],
    include=("id", "date", "time", "duration", "status", "reason", "notes", "follow_up", "created_at", "updated_at", "doctor", "patient")
)
