...
import { mockDoctors } from '@/mocks/users';
        ...
        <View style={styles.formSection}>
          ...
          >
            ...
            <View style={styles.doctorInfo}>
              ...
              <Text style={styles.doctorSpecialty}>{selectedDoctor.specialty} • {selectedDoctor.rating} ★</Text>
            </View>
            <ChevronDown size={20} color={Colors.textSecondary} />
          </TouchableOpacity>
              ...
              {mockDoctors.map((doctor) => (
                ...
                >
                  ...
                  <View style={styles.doctorItemInfo}>
                    ...
                    <Text style={styles.doctorItemSpecialty}>{doctor.specialty} • {doctor.rating} ★</Text>
                  </View>
                </TouchableOpacity>
              ))}
            </View>
